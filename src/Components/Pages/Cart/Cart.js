  ...
  return (
    ...
    {cart.length !== 0 &&
          ...
          return (
           <tbody key={id}>         
              <tr className="mb-2 cart_Item">
                <td>
                  <img src={image} alt={title} className="img-fluid" style={{width : '60px', height : '60px'}}/>
                </td>
      ...
      <div className="d-flex justify-content-center container-fluid mt-5 text-center cart_item">
        ...
        { cart.length !== 0 && <div className="total_cost pt-2 mb-3 mt-2">
            Total Cost: ${getTotalSum()}
          </div>
        }
            {/* checkout btn */}
           {cart.length !== 0 && <button> <NavLink to="/checkout"  className="text-white"> Checkout </NavLink> </button> }
   ...
   <div className="text-center">
         ...
         <h5 style={{color:'#ccc' , fontWeight : 'bolder', fontSize : '24px'}} className="mb-4">Your cart is empty!</h5>
         <h6 style={{fontWeight : '500' , fontSize : '18px'}} className="mb-4">Browse our categories and discover our best deals!</h6>
       </div>
       }
